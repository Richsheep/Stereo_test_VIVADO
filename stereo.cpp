...
//#pragma HLS INTERFACE axis port=input_l
//#pragma HLS INTERFACE axis port=input_r
//#pragma HLS INTERFACE axis port=disp_axi
...
RGB_IMAGE img_out(rows, cols);/*从流读出图像，至HLS_MAT*/
BMState BM;
